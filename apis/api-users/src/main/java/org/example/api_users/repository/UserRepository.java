...
public interface UserRepository extends JpaRepository<User, String> {
    ...
    @Query(value = "SELECT * FROM ( " +
            "    SELECT u.user_id, u.image_name, u.user_name, u.user_username, fr.finished_day AS update_date, 'FinishedRoute' AS update_type, fr.route_id AS description " +
            "    FROM friends f " +
            ...
            "    UNION " +
            "    SELECT u.user_id, u.image_name, u.user_name, u.user_username, ua.award_date AS update_date, 'Award' AS update_type, CONCAT(ua.award, ' Level ', ua.award_level) AS description " +
            "    FROM friends f " +
            "    JOIN friends f1 ON f1.user_1_id = f.user_2_id AND f.user_1_id = f1.user_2_id " +
            "    JOIN users u ON u.user_id = f.user_2_id " +
            ...
            "    WHERE f.user_1_id = :userId " +
            "    UNION " +
            "    SELECT u.user_id, u.image_name, u.user_name, u.user_username, fr.finished_day AS update_date, 'Collectable' AS update_type, uc.collectable AS description " +
            "    FROM friends f " +
            "    JOIN friends f1 ON f1.user_1_id = f.user_2_id AND f.user_1_id = f1.user_2_id " +
            "    JOIN users u ON u.user_id = f.user_2_id " +
            ...
            "    WHERE f.user_1_id = :userId " +
            "    UNION " +
            "    SELECT u.user_id, u.image_name, u.user_name, u.user_username, GREATEST(f2.friendship_date, f3.friendship_date) AS update_date, 'Friend' AS update_type, " +
